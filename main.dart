                      ...
                      Container(
                        ...
                        child : Card(
                          ...
                          child: ListTile(
                            leading: GetIcons.getIcon(icon),
                            title: Text(
                              'Speed :  ${speed != null ? speed.toString():'Loading ..'} mps',style: TextStyle(fontSize: 28,color: Colors.white),
                            ),
                            subtitle: Text('Degree :  ${dig != null ? dig.toString()+'\u00b0':'Loading ..'}',style: TextStyle(fontSize: 20,color: Colors.white),),
                          ),
                        ),
                      ),
                    ],
